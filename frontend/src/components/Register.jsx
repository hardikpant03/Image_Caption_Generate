    ...
    return (
        <div className="login-container">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div style={{display:"Flex" , justifyContent:"space-between"}}><button type="submit" className="btnsignup" style={{marginBottom:"13px"}}>Sign Up</button>
                <button type="submit" className="btnsignup" style={{marginBottom:"13px" , paddingtop:"20px"}}
                onClick={()=>navigate('/login')}>Already User</button>
                </div>
            </form>
            </div>
